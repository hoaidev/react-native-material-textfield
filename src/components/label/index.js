...
export default class Label extends PureComponent {
    ...
    render() {
        ...
        let containerStyle = {
            transform: [
                { scale: labelAnimation.interpolate({ inputRange: [0, 1], outputRange: [1, activeFontSize / fontSize] }) },
                { translateY: labelAnimation.interpolate({ inputRange: [0, 1], outputRange: [y0, y1] }) },
                { translateX: labelAnimation.interpolate({ inputRange: [0, 1], outputRange: [x0, x1] }) }
            ]
        };
        return (
