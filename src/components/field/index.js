...
function startAnimation(animation, options = {}, callback) {
    Animated.timing(animation, { ...options, useNativeDriver: false }).start(callback);
}
...
export default class TextField extends PureComponent {
    ...
    renderHelper() {
        ...
        let { title, disabled, baseColor, errorColor, titleTextStyle: style, characterRestriction: limit } = this.props;
